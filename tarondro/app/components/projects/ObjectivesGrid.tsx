...
//           {/* Ligne animée droite → gauche avec petit rebond */}
//           <motion.div
//             initial={{ scaleX: 0 }}
...
//               ease: [0.2, 0.8, 0.4, 1],
//             }}
//             className="h-2 bg-[#558B2F] rounded-full mt-4 w-32 origin-right"
//             style={{ transformOrigin: "right center" }}
//           >
//             {/* Optionnel : effet rebond via keyframes */}
//             <motion.div
//               className="h-2 bg-[#558B2F] rounded-full"
//               initial={{ scaleX: 0 }}
//               animate={{ scaleX: [0, 1.1, 0.95, 1] }}
//               transition={{
//                 duration: 1.4,
//                 delay: 0.7,
//                 ease: [0.2, 0.8, 0.4, 1],
...
//                 >
//                   <obj.icon
//                     className="w-16 h-16 text-[#558B2F]"
//                     strokeWidth={1.5}
//                   />
//                 </motion.div>
...
//               <motion.div className="absolute inset-x-6 -bottom-6 h-12 bg-[#558B2F]/20 blur-3xl scale-0 group-hover:scale-100 transition-transform duration-700 -z-10" />
//             </motion.div>
//           ))}
//         </div>
//       </div>
    ...
    <section id="objetifs" className="py-32 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="text-center mb-24">
          ...
          {/* Ligne animée droite → gauche avec rebond subtil */}
          <motion.div
            className="h-2 bg-[#558B2F] rounded-full mt-4 w-32 origin-right mx-auto"
            initial={{ scaleX: 0 }}
            whileInView={{ scaleX: 1 }}
            viewport={{ once: false, amount: 0.4 }}
            transition={{ duration: 1.2, delay: 0.7, ease: [0.2, 0.8, 0.4, 1] }}
            style={{ transformOrigin: "right center" }}
          >
            <motion.div
              className="h-2 bg-[#558B2F] rounded-full"
              initial={{ scaleX: -20 }}
              animate={{ scaleX: [0, 1.05, 0.98, 1] }} // rebond subtil
              transition={{ duration: 1.2, delay: 0.7, ease: [0.2, 0.8, 0.4, 1] }}
              style={{ transformOrigin: "right center" }}
            />
          </motion.div>
        ...
        {/* CARTES – responsive et dynamiques */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
          {objectives.map((obj, i) => (
            <motion.div
              ...
              className="group relative"
            >
              <div className="bg-white rounded-3xl p-8 md:p-12 text-center shadow-xl hover:shadow-2xl hover:shadow-[#558B2F]/25 transition-all duration-500">
                {/* Icône flottante */}
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <obj.icon className="w-14 md:w-16 h-14 md:h-16 text-[#558B2F]" strokeWidth={1.5} />
                </motion.div>
                ...
                >
                  <ArrowUpRight className="w-6 md:w-7 h-6 md:h-7 mx-auto text-[#558B2F]" />
                </motion.div>
              </div>

              {/* Ombre verte douce au hover */}
              <motion.div className="absolute inset-x-6 -bottom-6 h-12 bg-[#558B2F]/20 blur-3xl scale-0 group-hover:scale-100 transition-transform duration-700 -z-10" />
            </motion.div>
          ))}
        </div>
